...
SensorMenu()
{
	while true
        do
		printf '\033\143'
		echo "Which sensor to set, Enter number to choose."
		echo ""
		echo " Sensor             mode              data"
		echo ""
...
main()
{
    ...
    do
        printf '\033\143'
        echo "         PEBBLE  DATA   GENERATOR"
        echo ""
        echo ""
        echo " 1.  Set Sensor  mode."
        echo ""
        echo " 2.  Generate data."
        echo ""
        echo " 3.  Count of packages: $CountPkg ."
        echo ""
        echo " 4.  Exit."
        echo ""
        echo "Select:"
